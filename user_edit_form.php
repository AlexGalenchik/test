...
$list = array (
  array ('value'=>'Брестская', 'display'=>'Брестская')
 ,array ('value'=>'Гродненская', 'display'=>'Гродненская')
 ,array ('value'=>'Гомельская', 'display'=>'Гомельская')
 ,array ('value'=>'Витебская', 'display'=>'Витебская')
 ,array ('value'=>'ОАДО', 'display'=>'ОАДО')
 ,array ('value'=>'УРС', 'display'=>'УРС')
 ,array ('value'=>'Могилевская', 'display'=>'Могилевская')
 ,array ('value'=>'Админ', 'display'=>'Админ')
);

$info[] = $info1 = array (
   'field' => 'Регион'
  ,'value' => PrvFill('reg_user',$row['reg_user'])
  ,'el_type' => 'select'
  ,'id' => 'select_field'
  ,'name' => 'reg_user'
  ,'list' => $list
...
$list = array (
  array ('value'=>'r', 'display'=>'Чтение')
 ,array ('value'=>'w', 'display'=>'Запись')
 
);

$info[] = $info1 = array (
   'field' => 'Права (БД Договоров)'
  ,'value' => PrvFill('rights',$row['rights'])
  ,'el_type' => 'select'
  ,'id' => 'select_field'
  ,'name' => 'rights'
  ,'list' => $list
...
echo "<div>";
echo "<table><tr>";
echo "<td><span style=\"padding:3px;float:left;\"><img style=\"border:2px solid red;border-radius:10px;\" src='pics/users/".$info[4]['value'].".jpg'  ></td>";
echo "</tr></table>";
echo "</div>";
...
for ($i=0; $i<mysql_num_rows($query2); $i++) {
  $row2 = mysql_fetch_array($query2); 
  if ($row2[1] == 'maps') {$find = true; break;} else {$find = false;}
}
$s++;
echo "<tr>";
echo "<td id='ad_td'>Карта<input type='text' value='maps' name='object_access_$s' hidden></td>";
if ($row2[2] == 'r' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='r'></td>";
if ($row2[2] == 'w' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='w'><input type='text' value='".(($find)? $row2[0] : '')."' hidden name='Id_$s'></td>";
...
for ($i=0; $i<mysql_num_rows($query2); $i++) {
  $row2 = mysql_fetch_array($query2); 
  if ($row2[1] == 'counters') {$find = true; break;} else {$find = false;}
}
$s++;
echo "<tr>";
echo "<td id='ad_td'>Счётчики БС<input type='text' value='counters' name='object_access_$s' hidden></td>";
if ($row2[2] == 'r' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='r'></td>";
if ($row2[2] == 'w' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='w'><input type='text' value='".(($find)? $row2[0] : '')."' hidden name='Id_$s'></td>";
...
for ($i=0; $i<mysql_num_rows($query2); $i++) {
  $row2 = mysql_fetch_array($query2); 
  if ($row2[1] == 'podv') {$find = true; break;} else {$find = false;}
}
$s++;
echo "<tr>";
echo "<td id='ad_td'>Подвижные БС<input type='text' value='podv' name='object_access_$s' hidden></td>";
if ($row2[2] == 'r' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='r'></td>";
if ($row2[2] == 'w' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='w'><input type='text' value='".(($find)? $row2[0] : '')."' hidden name='Id_$s'></td>";
...
for ($i=0; $i<mysql_num_rows($query2); $i++) {
  $row2 = mysql_fetch_array($query2); 
  if ($row2[1] == 'hw') {$find = true; break;} else {$find = false;}
}
$s++;
echo "<tr>";
echo "<td id='ad_td'>Hardware<input type='text' value='hw' name='object_access_$s' hidden></td>";
if ($row2[2] == 'r' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='r'></td>";
if ($row2[2] == 'w' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='w'><input type='text' value='".(($find)? $row2[0] : '')."' hidden name='Id_$s'></td>";
...
for ($i=0; $i<mysql_num_rows($query2); $i++) {
  $row2 = mysql_fetch_array($query2); 
  if ($row2[1] == 'doc') {$find = true; break;} else {$find = false;}
}
$s++;
echo "<tr>";
echo "<td id='ad_td'>Документация<input type='text' value='doc' name='object_access_$s' hidden></td>";
if ($row2[2] == 'r' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='r'></td>";
if ($row2[2] == 'w' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='w'><input type='text' value='".(($find)? $row2[0] : '')."' hidden name='Id_$s'></td>";
...
for ($i=0; $i<mysql_num_rows($query2); $i++) {
  $row2 = mysql_fetch_array($query2); 
  if ($row2[1] == 'geo') {$find = true; break;} else {$find = false;}
}
$s++;
echo "<tr>";
echo "<td id='ad_td'>Гео Поиск БС<input type='text' value='geo' name='object_access_$s' hidden></td>";
if ($row2[2] == 'r' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='r'></td>";
if ($row2[2] == 'w' && ($find)) {$checked = 'checked';} else {$checked = '';}
echo "<td id='ad_td' style='text-align:center;'><input type='checkbox' $checked name='access_type_$s' value='w'><input type='text' value='".(($find)? $row2[0] : '')."' hidden name='Id_$s'></td>";
