...
$data = array (
  ...
  ,'selsovet' => $_POST['selsovet'] //Добавлено при корректировке адресов в Базе
  ...
  ,'construction_5g_type_id' => $_POST['construction_5g_type_id'] // 5G Добавлено
  ,'model_type_4g' => $_POST['model_type_4g']
  ,'model_type_5g' => $_POST['model_type_5g']  // 5G Добавлено
