...
$info[] = $info1 = array (
 'field' => 'привязывается по ВОЛС'
,'value' => PrvFill('focl_U900',$row['focl_U900'])
,'el_type' => 'checkbox'
,'name' => 'focl_U900'
);
$info[] = $info1 = array (
 'field' => 'привязывается по Аренде РУП "Белтелеком"'
,'value' => PrvFill('rent_U900',$row['rent_U900'])
,'el_type' => 'checkbox'
,'name' => 'rent_U900'
);
$info[] = $info1 = array (
...
$info[] = $info1 = array (
 'field' => 'привязывается по ВОЛС'
,'value' => PrvFill('focl_LTE',$row['focl_LTE'])
,'el_type' => 'checkbox'
,'name' => 'focl_LTE'
);
$info[] = $info1 = array (
 'field' => 'привязывается по Аренде РУП "Белтелеком"'
,'value' => PrvFill('rent_LTE',$row['rent_LTE'])
,'el_type' => 'checkbox'
,'name' => 'rent_LTE'
);
$info[] = $info1 = array (
...
if ($row_count>0) {
  ...
  for ($i=0; $i<$row_count; $i++) {
    ...
    echo "<b><span style='color: blue;'>БС".$row2[0]."</span></b></td>";
	...
	if ($value=='11 GHz') {$selected='selected';} else {$selected='';}
    echo "<option $selected value='11 GHz'>11 GHz</option>";
    ...
    if ($value=='500 Мб/c') {$selected='selected';} else {$selected='';}
    echo "<option $selected value='500 Мб/c'>500 Мб/c</option>";
	if ($value=='1 Гб/c') {$selected='selected';} else {$selected='';}
    echo "<option $selected value='1 Гб/c'>1 Гб/c</option>";
    echo "</select></td>";
    ...
    if ($value=='2+0') {$selected='selected';} else {$selected='';}
    echo "<option $selected value='2+0'>2+0</option>";
    echo "</select></td>";
