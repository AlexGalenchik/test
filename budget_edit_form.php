...
$sql=$sql.",umts_config ";
$sql=$sql.",budget.umts900_config_id as umts900_config_id";//Добавлено для U900
$sql=$sql.",umts900_config "; //Добавлено для U900
...
$sql=$sql."LEFT JOIN umts900_configs ";
$sql=$sql."ON umts900_config_id=umts900_configs.id ";
...
$sql2="SELECT umts900_config,Id FROM umts900_configs ORDER BY umts900_config";
$query2=mysql_query($sql2) or die(mysql_error());
array_splice ($list,0);
$list[] = array ('value'=>'', 'display'=>'');
for ($i=0; $i<mysql_num_rows($query2); $i++) {
...
$info[] = $info1 = array (  //Добавлено для U900 ввод данных по конфигурации
 'field' => 'Конфигурация UMTS 900'
,'value' => PrvFill('umts900_config_id',$row['umts900_config_id'])
,'el_type' => 'select'
,'id' => 'select_field_medium'
,'name' => 'umts900_config_id'
,'list' => $list
,'ad_edit' => "ad_edit(&#039;redirect.php?f=5&ff=$section_index&obj=umts900_configs&#039;,&#039;budget_edit&#039;);"
);
