...
if ($editlist=='construction_5g_types')		//5G ƒобавлен
  {
  $table='construction_5g_types';
  $field='construction_type';
  $field_title='тип металлоконструкции 5G';
  }      
...
if ($editlist=='umts900_configs')
  {
  $table='umts900_configs';
  $field='umts900_config';
  $field_title='тип конфигурации umts900';
  }  
...
if ($editlist=='5g_configs')		//5G ƒобавлен
  {
  $table='5g_configs';
  $field='5g_config';
  $field_title='тип конфигурации 5g';
  }    
...
if ($editlist=='build_organizations')
  ...
  $field='title';
  $field_title='строительна€ организаци€';
  $cond='';
  }   
if ($editlist=='project_organizations')
  ...
  $field='title';
  $field_title='проектна€ организаци€';
  $cond='';
  }   
...
if ($editlist=='rep_diapazons')
  {
  $table='rep_diapazons';
  $field='rep_diapazon';
  $field_title='диапазон';
  }  
...
if ($editlist=='settlements')
  ...
  if ($row[1]=='аг.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='аг.'>агрогородок</option>";
  if ($row[1]=='г.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='г.'>город</option>";
  if ($row[1]=='пос.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='пос.'>посЄлок</option>";
  if ($row[1]=='село') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='село'>село</option>";
  if ($row[1]=='сан.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='сан.'>санаторий</option>";
  if ($row[1]=='трасса') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='трасса'>трасса</option>";
  if ($row[1]=='ур-ще') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='ур-ще'>урочище</option>";
  if ($row[1]=='ур.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='ур.'>уречье</option>";
  if ($row[1]=='д.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='д.'>деревн€</option>";
  if ($row[1]=='г.п.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='г.п.'>городской поселок</option>";
  if ($row[1]=='ст.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='станци€'>станци€</option>";
  if ($row[1]=='н.п.') {$selected='selected';} else {$selected='';}
  echo "<option $selected value='н.п.'>населенный пункт</option>";
  echo "</select></div>";
  } 
if ($editlist=='antenna_types')
  {
  ...
  if ($row[1]=='5g') {$selected='selected';} else {$selected='';}			//5G ƒобавлен
