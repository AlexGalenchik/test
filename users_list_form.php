...
if (mysql_num_rows($query)>0) {
  ...
  echo "<td id='rs_td'><a href='#' title='сортировать' onclick='ad_edit(&#039;index.php?f=21&sort=region&#039;,&#039;users_list&#039;);');'><img src='pics/sort_pic.png' width='16' height='16'></a>&nbsp;регион</td>";
  echo "<td id='rs_td'></td>";
  echo "</tr>";
