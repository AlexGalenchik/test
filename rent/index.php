			...
			<div class="col-md-6" style="margin-left: 10px;"><!--            Данные по договору-->
                ...
                <div class="row block">
					<div class="col">
					  <h5>Реквизиты</h5>
<?php 
If ($data[0]['type_arenda'] == 'МТС Арендует РПС' || $data[0]['type_arenda'] == 'МТС Арендует Офисы и т.д.') { ?>
						<div class="box">
...
<?php } ?>
<?php 
If ($data[0]['type_arenda'] == 'Техническая поддержка') { ?>
						<div class="box">
							<input type="text" id="arendodatel" name="arendodatel" value="<?php echo $data[0]['arendodatel']; ?>" disabled>
							<label for="arendodatel">Контрагент</label>
						</div>
<?php } ?>
<?php If ($data[0]['type_arenda'] == 'МТС Сдает') { ?>						
						<div class="box">
...
<?php } ?>
		...
		<div class="col-md-6" style="margin-left: -10px;"><!--        параметры догвора-->
			...
			-->		
					...
					<div class="box">
                        <input type="text" id="proverka_contragenta" name="proverka_contragenta" value="<?php echo $data[0]['proverka_contragenta']; ?>" disabled>
                        <label for="proverka_contragenta">Проверка контрагента</label>
                    
                        <input type="date" id="data_proverki" name="data_proverki" value="<?php echo $data[0]['data_proverki']; ?>" disabled>
					...
					<div class="box">
						<textarea id="notes" rows="4" name="notes" placeholder="<?php echo $data[0]['notes']; ?>" disabled></textarea>
                    ...
                    <div class="row block"><!--        офисы и склады-->
                        <div class="col">
							...
							<div class="box">
                                ...
                                <input type="text" id="arhiv" name="arhiv" value="<?php echo $data[0]['arhiv']; ?>" disabled>
                            </div>
