    ...
    <div class="row mx-1 my-1">
			...
			<div class="col-md-6" style="margin-left: 10px;">
				...
				<div class="row block">
					<div class="col">
					  <h5>Реквизиты</h5>
<?php IF ($row['type_arenda'] == 'МТС Арендует РПС' || $row['type_arenda'] == 'МТС Арендует Офисы и т.д.') { ?>
						<div class="box">
...
<?php } ?>
<?php IF ($row['type_arenda'] == 'Техническая поддержка' ) { ?>
						<div class="box">
							<input type="text" id="arendodatel" name="arendodatel" value="<?php echo $row['arendodatel']; ?>" >
							<!-- <label for="arendodatel">Арендодатель</label> -->
							<label for="arendodatel">Контрагент</label>
						</div>
<?php } ?>	
<?php IF ($row['type_arenda'] == 'МТС Сдает' ) { ?>						
						<div class="box">
...
<?php } ?>						
						...
						<div class="box">
							<select id="type_dogovor" name="type_dogovor" value="<?php echo $row['dogovor_type']; ?>" >
								...
								<option value="эксплуатационные расходы">эксплуатационные расходы</option>
		...
		<div class="col-md-6" style="margin-left: -10px;"><!--        параметры догвора-->
			...
			-->		
					...
					<div class="box">
                        <select id="proverka_contragenta" name="proverka_contragenta" >
							<option value="<?php echo $row['proverka_contragenta']; ?>"><?php echo $row['proverka_contragenta']; ?></option>
							<option value=""></option>
							<option value="дата">дата</option>
							<option value="не требуется">не требуется</option>
							<option value="запрос направлен">запрос направлен</option>
							<option value="нет">нет</option>
						</select>	
                        <label for="proverka_contragenta">Проверка контрагента</label>
                    
						<input type="date" id="data_proverki" name="data_proverki" value="<?php echo $row['data_proverki']; ?>" >
						<label for="data_proverki"></label>
					</div>
					<div class="box" >
