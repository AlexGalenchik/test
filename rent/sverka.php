                ...
                <div class="row align-items-center"><!-- row 2 -->
                    ...
                    <div class="col-md-9 pull-3">
					 ...
					 <div class="col-md-5 ">
										...
										<?php } ?>
											<a href="loadExcelSverka.php"><button type="button" class="btn btn-danger">Excel</button></a>
											<a href="../history_reports/"><button type="button" class="btn btn-danger">История (Excel)</button></a>
