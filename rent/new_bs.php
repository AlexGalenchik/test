			...
			<!-- Конец скрипта для выбора типов оборудования -->
                    ...
                    <div class="col-md-12 col-lg-6">
                        ...
                        <div class="box">
							...
							<?php if($_SESSION['reg_user'] == 'Админ' || $_SESSION['reg_user'] == 'УРС') { ?>
							...
							<?php } else { 	
										If($_SESSION['reg_user'] == 'ОАДО') {
											...
											$obl = $_SESSION['reg_user'];
										}
								
							?>
								<input type="text" id="region" name="region" style="width: 75%;" value="<?php echo $obl;?>" required>
                        ...
                        <div class="box">
                            ...
                            <select id="area" name="area" style="width: 75%;">
								...
								If ($_SESSION['reg_user'] !== 'Админ') {
									...
									$sql_areas = " SELECT area FROM areas ";
								}
