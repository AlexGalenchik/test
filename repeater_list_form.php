...
// формируем элементы - Поиск по номеру БС
$searchinfo = array (
 'el_type' => 'text'
...
// формируем элементы - Поиск по тексту адреса
$adsearchinfo = array (
 'el_type' => 'text'
,'value' => $searchstring 
,'id' => 'select_field'
...
echo "<br/>";
echo "<div id='inline'>";
echo "<form action='redirect.php?f=30' method='post'>введите номер Репитера:&nbsp;&nbsp;&nbsp;";
...
echo "<div id='inline'>";
echo "<form action='redirect.php?f=28' method='post' id='repeaters_list' placeholder='Введите адрес репитера'>";
echo "&nbsp;&nbsp;&nbsp;<img src='pics/search_pic.png' width='20' height='20'>&nbsp;";
