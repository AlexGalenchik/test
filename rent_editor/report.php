...
echo "<td colspan='2'><b>МТС АРЕНДУЕТ</b></td>";
echo "</div>";
...
echo "<div id='table_head'>";
echo "<td colspan='2'><b>ОФИСЫ МТС</b></td>";
echo "</div>";
...
foreach (Payment ($region,'МТС Арендует') as $key => $value) {
...
echo "<table>";
echo "<th colspan='2'><b>ПЛАТЕЖИ ПО АРЕНДЕ</b></th>";
foreach (Payment ($region,'Офисы МТС') as $key => $value) {
    	echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
	}
echo "</table></div>";
echo "</div>";
...
foreach (Room_Cables ($region,'МТС Арендует') as $key => $value) {
    	echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
	}
echo "</table></div>";
...
echo "<table>";
echo "<th colspan='2'><b>ПЛОЩАДИ, ДЛИНА, МЕТРАЖ</b></th>";
foreach (Room_Cables ($region,'Офисы МТС') as $key => $value) {
    	echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
	}
echo "</table></div>";
echo "</div>";
...
FOR ($k=0;$k<count($types);$k++) {
	If ($types[$k][type] !== Null) {
		foreach (TypeHW ($region,'МТС Арендует',$types[$k][type]) as $key => $value) {
			echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
		}
	}
}	
...
FOR ($k=0;$k<count($types);$k++) {
	If ($types[$k][type] !== Null) {
		foreach (TypeHW ($region,'Офисы МТС',$types[$k][type]) as $key => $value) {
			echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
		}
	}
}	
...
FOR ($k=0;$k<count($ispolnitels);$k++) {
	If ($ispolnitels[$k][ispolnitel] !== Null) {
		foreach (Payment_Ispolnitel ($region,'МТС Арендует',$ispolnitels[$k][ispolnitel]) as $key => $value) {
			echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
		}
	}
}	
...
FOR ($k=0;$k<count($ispolnitels);$k++) {
	If ($ispolnitels[$k][ispolnitel] !== Null) {
		foreach (Payment_Ispolnitel ($region,'Офисы МТС',$ispolnitels[$k][ispolnitel]) as $key => $value) {
			echo "<tr><td>".$key."</td><td><b>".$value."</b></td></tr>";	
		}
	}
}	
