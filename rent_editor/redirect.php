...
if ( (isset($_POST['numBS_MTS']) && !empty($_POST['numBS_MTS']) ) ) {
			...
			/////////////////////////ОФИСЫ и СКЛАДЫ///////////////////////////////////
			$naznachenie = $_POST['naznachenie']; 				//Назначение офиса (тектовое)
			...
			$type_rent_propety = $_POST['type_rent_propety']; //Тип арендуемого имущества (под примечанием находится

			$naznachenie = clean($naznachenie); 
